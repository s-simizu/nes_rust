...
lazy_static! {
    pub static ref CPU_OPS_CODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x69, "SBC", 2, 2, AddressingMode::Immediate),
        OpCode::new(0x65, "SBC", 2, 3, AddressingMode::ZeroPage),
        OpCode::new(0x75, "SBC", 2, 4, AddressingMode::ZeroPage_X),
        OpCode::new(0x6d, "SBC", 3, 4, AddressingMode::Absolute),
        OpCode::new(0x7d, "SBC", 3, 4, AddressingMode::Absolute_X),
        OpCode::new(0x79, "SBC", 3, 4, AddressingMode::Absolute_Y),
        OpCode::new(0x61, "SBC", 2, 6, AddressingMode::Indirect_X),
        OpCode::new(0x71, "SBC", 2, 5, AddressingMode::Indirect_Y),
